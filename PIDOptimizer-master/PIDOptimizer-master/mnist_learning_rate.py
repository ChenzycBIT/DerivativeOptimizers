...
num_epochs = 5
batch_size = 100
learning_rates = [0.1, 0.01, 0.01, 0.06, 0.05, 0.05, 0.05, 0.05, 0.05, 0.05, 0.05, 0.05, 0.05, 0.05]
...
learning_rates = [0.0001, 0.001, 0.01, 0.05, 0.1, 0.3]
...
for i in range(6):
    comparing_data.append(training(optimizer_sign=2, learning_rate=learning_rates[i]))
...
labels = ['Adam lr=0.0001', 'Adam lr=0.001', 'Adam lr=0.01', 'Adam lr=0.05', 'Adam lr=0.1', 'Adam lr=0.3', ]
